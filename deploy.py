...
- ``video-gen-model``  monocular video motion capture -> skeletal-animation GLB
                       (body + fingers rotation channels, face translation
                       channels; single subject, largest person tracked)
